...
public class Solution972 {
	...
	public static void main(String[] args) {
		String S = "1/6"; String T = "10/60";
		Solution972 obj = new Solution972();
		System.out.println(obj.isRationalEqual(S, T));
	}
